describe('Test whether all ERC galley functionality is available.', () => {
    ...
    it('Test components of ERC Galley', () => {
        ...
        cy.get('a.obj_galley_link').click();
        ...
        cy.getIframeBody('[name="htmlFrame"]')
            ...
            .contains('2021-11-29T11:45:02.541Z')
            .should('be.visible');
        ...
        cy.getIframeBody('[name="htmlFrame"]')
            .find('span.MuiTypography-h5')
            .contains('849ee252-4c62-4016-812e-bdeb32f8e33d')
            .scrollIntoView()
            .should('be.visible');
        cy.getIframeBody('[name="htmlFrame"]')
        ...
        /*
        cy.wait(10000);
        //cy.get('#htmlContainer')//.debug();

        cy.visit('/o2rn/article/download/1/erc-geQfc');
        cy.wait(20000);
        */
    });
});